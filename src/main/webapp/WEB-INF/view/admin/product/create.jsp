                                        ...
                                        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                                            <form:form action="/create/product/finish" method="post"
                                                ...
                                                <div data-mdb-input-init class="form-outline mb-4">
                                                    ...
                                                    <label class="form-label" for="form3Example3">Tên sản phẩm</label>
                                                </div>
                                                ...
                                                <div style="display: flex;">
                                                    ...
                                                    <div data-mdb-input-init class="form-outline mb-3">
                                                        <form:input type="text" id="form3Example4"
                                                            ...
                                                            placeholder="Enter password" style="width: 93%;"
                                                            path="shortDes" />
                                                        <label class="form-label" for="form3Example4">Mô tả sơ bộ</label>
                                                    </div>
                                                ...
                                                <div class="text-center text-lg-start mt-4 pt-2">
                                                    <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                                        ...
                                                        style="padding-left: 2.5rem; padding-right: 2.5rem;">Thêm sản phẩm</button>
                                                </div>
